...
const strategyDetail = {
  ...
  recentDecisions: [],
  publishedResearchProvenance: null,
  hostEvidencePresence: { lifecycleStates: false, governanceHistory: false, promotionHistory: false, walkForwardRuns: false, researchPublications: false },
  currentStates: [],
  governanceHistory: [],
  promotionHistory: [],
  walkForwardRuns: [],
