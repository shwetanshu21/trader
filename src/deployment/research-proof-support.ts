...
// ===========================================================================
// T04 — Real service ingress: mocked transport + service factory
// ===========================================================================
 ...
 *
 * This factory mirrors the walk-forward mocking pattern used by the S05 proof
 * harness Phase 3, extracted as a reusable factory so the proof harness can
 * wire it into the HypothesisGenerationService.generate() accepted+eval path.
 */
